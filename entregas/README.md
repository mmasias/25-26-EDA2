...
Estado inicial y final. Mostrar el array antes de comenzar y después de terminar.
Cada decisión relevante. Toda comparación que determine un intercambio, un desplazamiento o la elección de un camino de ejecución debe quedar registrada, indicando los valores comparados y el resultado de la comparación.
Cada modificación del array. Cada vez que un elemento cambia de posición, mostrar el array resultante o al menos la operación realizada.
Profundidad de recursión visible. En los algoritmos recursivos, la traza de cada llamada debe estar indentada proporcionalmente a su nivel de recursión, de forma que el árbol de llamadas sea legible directamente en la salida.
Identificación de casos base. Señalar explícitamente cuándo se alcanza un caso base y por qué.
Array de prueba
