...
Este programa resuelve el criptaritmo asignando un número a cada letra usando 
recursividad. Va probando combinaciones hasta encontrar una que cumpla la suma.
...
Después se sigue con las siguientes en orden: E, N, D, M, O, R, Y.
...
- Se forman los números SEND, MORE y MONEY.
...
Por eso se multiplica por 1000, 100, 10 o 1, para formar el número correctamente.

## Optimización

Al poner primero M y S, se fijan antes las letras más restrictivas (las que no pueden ser 0 y afectan más al resultado).
...
- Poner S y M al final del array
- Y recorrer de 0 a 9
